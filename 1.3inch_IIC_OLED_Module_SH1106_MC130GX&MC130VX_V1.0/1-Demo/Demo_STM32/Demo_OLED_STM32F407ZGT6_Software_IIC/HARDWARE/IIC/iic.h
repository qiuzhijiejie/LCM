...
//本模块默认数据总线类型为IIC
// OLED模块               STM32单片机
//   SDA         接          PB5         //OLED屏IIC数据信号
//=======================================液晶屏控制线接线==========================================//
// OLED模块               STM32单片机
//   SCL         接          PB3         //OLED屏IIC时钟信号
//=========================================触摸屏接线=========================================//
...
//--------------IIC总线引脚定义-----------------------
#define OLED_SDA       GPIO_Pin_5  //OLED屏IIC数据信号
#define OLED_SCL       GPIO_Pin_3  //OLED屏IIC时钟信号
...
//设置数据IO的方向
#define OLED_SDA_IN()  {GPIOB->MODER&=~(3<<(5*2));GPIOB->MODER|=0<<5*2;}	//PB5输入模式
#define OLED_SDA_OUT() {GPIOB->MODER&=~(3<<(5*2));GPIOB->MODER|=1<<5*2;} //PB5输出模式
