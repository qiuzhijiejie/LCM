...
//		OLED_ShowChinese(90,0,4,16);//
		...
		OLED_ShowString(20,5,"2025/09/10",16);
...
//	OLED_ShowChinese(90,3,9,16);
	OLED_ShowString(16,3,"0.91Inch_OLED",16);
	delay_ms(100);

OLED_Fill_Row(0xFF, 0x00); // 奇数行区间全亮，偶数行区间全灭
	delay_ms(100);
OLED_Fill_Row(0x00, 0xff); // 奇数行区间全亮，偶数行区间全灭	
	delay_ms(100);
OLED_Fill_Row(0xaa, 0x55); // 奇数行区间全亮，偶数行区间全灭	
	delay_ms(100);
OLED_Fill_Row(0x55, 0xaa); // 奇数行区间全亮，偶数行区间全灭	
	delay_ms(100);
