...
//G12864384
//sbit SDA = P1^2;  //SDA			  //定义串行数据脚为P1.4
//sbit SCK = P1^3;				  //定义串行时钟脚为P1.3
//sbit RS  = P1^0;  //A0			  //定义数据/指令控制脚为P1.2
//sbit RST = P1^1;				  //定义复位脚为P1.1
//sbit CS  = P1^4;			      //定义片选脚为P10


//HCG13264-70
sbit SDA = P3^1;  //SDA			  //定义串行数据脚为P1.4
sbit SCK = P1^7;				  //定义串行时钟脚为P1.3
sbit RS  = P1^6;  //A0			  //定义数据/指令控制脚为P1.2
sbit RST = P1^5;				  //定义复位脚为P1.1
sbit CS  = P1^4;			      //定义片选脚为P10
