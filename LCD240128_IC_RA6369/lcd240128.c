...
uchar start_x[] = {42, 41, 43};  // 每组显示的起始X坐标
uchar start_y[] = {20, 50, 80};  // 每组显示的起始Y坐标
uchar start_code[] = {0, 16, 34};  // 每组显示的起始字符编码
uchar count[] = {16, 18, 12};  // 每组显示的字符数量
uchar  group,i;
...
void Display_FullCGROM()
{
    ...
    uchar charCode = 0x00;    // 从 CGROM 的 0x00 开始
	...
	Display_Str(8,4,"ABCDEFGIHJKLMNOPQRSTUVWXYZ1234567890abcdefghijklmnopkrstuvwxyz!%$()*+-,./ABCDEFGIHJKLMNOPQRSTUVWXYZ1234567890abcdefghijklmnopkrst"); 
	Display_Str(0,0,"A");
	Display_Str(23,12,"ABCDEFGIHJKLMNOPQRSTUVWXYZ1234567890abcdefghijklmnopkrstuvwxyz!%$()*+-,./ABCDEFGIHJKLMNOPQRSTUVWXYZ1234567890abcdefghijklmnopkrst");
