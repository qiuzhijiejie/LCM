...
#define Vk2c24a_CLK 1 //SCL信号线频率,由delay_nus实现 50->10kHz 10->50kHz 5->100kHz

//segtab[]数组对应实际的芯片到LCD连线，连线见-Vk2c24a参考电路
//4com
...
//vk2c24a_dispram对应芯片的显示RAM
//4com
unsigned char vk2c24a_dispram[Vk2c24a_SEGNUM/2];//4COM时每个字节数据对应2个SEG
//8com
//unsigned char vk2c24a_dispram[Vk2c24a_SEGNUM];//8COM时每个字节数据对应1个SEG
//16com
//unsigned char vk2c24a_dispram[Vk2c24a_SEGNUM*2];//16COM时每2个字节数据对应1个SEG
//对应数组vk2c24a_segtab[Vk2c24a_SEGNUM]
...
//4COM
vk2c24a_dispram[Vk2c24a_SEGNUM/2]=
{//com3   com2   com1     com0 //对应芯片SEG脚  对应显示RAM数据
	1D,     1E,    1F,      1A,     //seg4   			vk2c24a_dispram[2]-bit3-bit0
	  ,     1C,    1G,      1B,     //seg5				vk2c24a_dispram[2]-bit7-bit4
	2D,     2E,    2F,      2A,     //seg6				vk2c24a_dispram[3]-bit3-bit0
	  ,     2C,    2G,      2B,     //seg7				vk2c24a_dispram[3]-bit7-bit4
	3D,     3E,    3F,      3A,		//seg8				vk2c24a_dispram[4]-bit3-bit0
	  ,     3C,    3G,      3B,		//seg9				vk2c24a_dispram[4]-bit7-bit4
}
//8COM
vk2c24a_dispram[Vk2c24a_SEGNUM]=
{//com7   com6   com5     com4   com3   com2   com1     com0 //对应芯片SEG脚  对应显示RAM数据
	 1D,     1E,    1F,      1A,    ,     1C,    1G,      1B,  //seg6   			vk2c24a_dispram[2]
	 2D,     2E,    2F,      2A,    ,     2C,    2G,      2B,  //seg7   			vk2c24a_dispram[3]
	 3D,     3E,    3F,      3A,    ,     3C,    3G,      3B,  //seg8   			vk2c24a_dispram[4]
}
*/
/*8字点序 
     A
...
unsigned char vk2c24a_maxcom=4;//驱动的com数VK2C24A可以是4com或者8com
...
//	WriteCmdVk2c24a(Vk2c24a_MODESET,BIAS_1_4|COM_4); 	//模式设置  1/3 Bais 1/4 Duty
//	WriteCmdVk2c24a(Vk2c24a_MODESET,BIAS_1_5|COM_4); 	//模式设置  1/3 Bais 1/4 Duty
	vk2c24a_maxcom=4;
//	WriteCmdVk2c24a(Vk2c24a_MODESET,BIAS_1_3|COM_8); 	//模式设置  1/3 Bais 1/8 Duty
//	WriteCmdVk2c24a(Vk2c24a_MODESET,BIAS_1_4|COM_8); 	//模式设置  1/3 Bais 1/8 Duty
//	WriteCmdVk2c24a(Vk2c24a_MODESET,BIAS_1_5|COM_8); 	//模式设置  1/3 Bais 1/8 Duty
//	vk2c24a_maxcom=8;
...
//	WriteCmdVk2c24a(Vk2c24a_IVASET,SEGSEL_IVA02H);	
}
/*******************************************************************************
