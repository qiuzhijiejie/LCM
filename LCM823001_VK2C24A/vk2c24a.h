...
#define Vk2c24a_MODESET		  0x82    // BIAS,COM设置
	...
	#define BIAS_1_5		 			0x05  	// 1/5bias	
	#define COM_4 						0x00  	// 4com
	#define COM_8 						0x02  	// 8com
	#define COM_16 						0x0A  	// 16com
...
//单片机SDA脚为单向IO要设为输出脚
//根据客户单片机修改
#define Vk2c24a_DIRDAT_PIN   	BIT5
#define Vk2c24a_DIRDAT_PORT  	PC
#define Vk2c24a_DIRDAT_IO    	PC5
#define Vk2c24a_SET_SDA_DIR() 	{\
	GPIO_SetMode(Vk2c24a_DIRDAT_PORT, Vk2c24a_DIRDAT_PIN, GPIO_MODE_OUTPUT);\
}
