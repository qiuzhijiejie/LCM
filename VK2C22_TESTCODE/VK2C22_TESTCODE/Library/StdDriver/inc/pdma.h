 ...
 */
#define PDMA_GET_INT_STATUS() ((unsigned int)(PDMA->INTSTS))
 ...
 */
#define PDMA_GET_TD_STS() ((unsigned int)(PDMA->TDSTS))
 ...
 */
#define PDMA_CLR_TD_FLAG(u32Mask) ((unsigned int)(PDMA->TDSTS = (u32Mask)))
 ...
 */
#define PDMA_GET_ABORT_STS() ((unsigned int)(PDMA->ABTSTS))
 ...
 */
#define PDMA_CLR_ABORT_FLAG(u32Mask) ((unsigned int)(PDMA->ABTSTS = (u32Mask)))
 ...
 */
#define PDMA_GET_EMPTY_STS() ((unsigned int)(PDMA->SCATSTS))
 ...
 */
#define PDMA_CLR_EMPTY_FLAG(u32Mask) ((unsigned int)(PDMA->SCATSTS = (u32Mask)))
 ...
 */
#define PDMA_CLR_TMOUT_FLAG(u32Ch) ((unsigned int)(PDMA->INTSTS = (1 << ((u32Ch) + 8))))
 ...
 */
#define PDMA_IS_CH_BUSY(u32Ch) ((unsigned int)(PDMA->TRGSTS & (1 << (u32Ch)))? 1 : 0)
 ...
 */
#define PDMA_SET_SRC_ADDR(u32Ch, u32Addr) ((unsigned int)(PDMA->DSCT[(u32Ch)].SA = (u32Addr)))
 ...
 */
#define PDMA_SET_DST_ADDR(u32Ch, u32Addr) ((unsigned int)(PDMA->DSCT[(u32Ch)].DA = (u32Addr)))
 ...
 */
#define PDMA_SET_TRANS_CNT(u32Ch, u32TransCount) ((unsigned int)(PDMA->DSCT[(u32Ch)].CTL=(PDMA->DSCT[(u32Ch)].CTL&~PDMA_DSCT_CTL_TXCNT_Msk)|(((u32TransCount)-1) << PDMA_DSCT_CTL_TXCNT_Pos)))
 ...
 */
#define PDMA_SET_SCATTER_DESC(u32Ch, u32Addr) ((unsigned int)(PDMA->DSCT[(u32Ch)].NEXT = (u32Addr) - (PDMA->SCATBA)))
 ...
 */
#define PDMA_STOP(u32Ch) ((unsigned int)(PDMA->STOP = (1 << (u32Ch))))
