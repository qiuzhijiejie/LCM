...
/**
  ...
  */
__STATIC_INLINE unsigned int CLK_GetPLLClockFreq(void)
{
...
/**
  ...
  */
__STATIC_INLINE void CLK_SysTickDelay(unsigned int us)
{
...
__STATIC_INLINE void CLK_SysTickLongDelay(unsigned int us)
{
    unsigned int delay;
