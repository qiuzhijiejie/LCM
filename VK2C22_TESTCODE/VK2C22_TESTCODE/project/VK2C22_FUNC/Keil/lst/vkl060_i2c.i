...
#line 1 "..\\lcd_driver\\VKL060_I2C.h"
...
#line 20 "..\\lcd_driver\\VKL060_I2C.h"
...
#line 15 "..\\lcd_driver\\VKL060_I2C.c"
...
void VKL060_I2C_Cmd(unsigned char* cmdbuf,unsigned char cnt);
void VKL060_I2C_WRDat(unsigned char Addr,unsigned char *Databuf,unsigned char cnt);
void VKL060_I2C_RDDat(unsigned char Addr,unsigned char *Databuf,unsigned char cnt);
...
void  WriteCmdVKL060(unsigned char cmd)
{
	VKL060_I2C_Cmd(&cmd,1);
}
...
void  WritenDataVKL060(unsigned char Addr,unsigned char *Databuf,unsigned char cnt)
{
	VKL060_I2C_WRDat(Addr,Databuf,cnt);
}
...
{
	VKL060_I2C_RDDat(Addr,Databuf,Cnt);
	return 0;
}
