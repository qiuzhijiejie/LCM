...
#line 1 "..\\lcd_driver\\VKL128_I2C.h"
...
#line 20 "..\\lcd_driver\\VKL128_I2C.h"
...
#line 15 "..\\lcd_driver\\VKL128_I2C.c"
...
unsigned char VKL128_dispram[18];
unsigned char VKL128_readbuf[18];
unsigned char VKL128_segi,VKL128_comi;
 
void VKL128_I2C_Cmd(unsigned char* cmdbuf,unsigned char cnt);
void VKL128_I2C_WRDat(unsigned char Addr,unsigned char *Databuf,unsigned char cnt);
void VKL128_I2C_RDDat(unsigned char Addr,unsigned char *Databuf,unsigned char cnt);
...
void  WriteCmdVKL128(unsigned char cmd)
{
	VKL128_I2C_Cmd(&cmd,1);
}
...
void  WritenDataVKL128(unsigned char Addr,unsigned char *Databuf,unsigned char cnt)
{
	VKL128_I2C_WRDat(Addr,Databuf,cnt);
}
...
{
	VKL128_I2C_RDDat(Addr,Databuf,Cnt);
	return 0;
}
