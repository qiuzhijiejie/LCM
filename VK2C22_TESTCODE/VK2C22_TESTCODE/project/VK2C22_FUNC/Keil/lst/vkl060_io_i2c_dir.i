...
#line 1 "..\\lcd_driver\\VKL060_IO_I2C_DIR.h"
...
#line 20 "..\\lcd_driver\\VKL060_IO_I2C_DIR.h"
...
void VKL060_DisDotOn(unsigned char seg,unsigned char com);
void VKL060_DisDotOff(unsigned char seg,unsigned char com);
unsigned char VKL060_Enter_PowerOff(void);
unsigned char VKL060_Exit_PowerOff(void);

void VKL060_Main(void);


 
#line 15 "..\\lcd_driver\\VKL060_IO_I2C_DIR.c"
...
unsigned char VKL060_dispram[8];
unsigned char VKL060_readbuf[8];
...
void VKL060_I2CWRCmd( unsigned char cmd )
{
	unsigned char i=8;
...
void VKL060_I2CWRDat( unsigned char dat )
{
	unsigned char i=8;
	while (i--)
	{ 
...
unsigned char VKL060_I2CRDDat( void )
{
...
unsigned char  WriteCmdVKL060(unsigned char cmd)
{
	
	VKL060_I2CStart(); 									
	
	VKL060_I2CWRCmd(0x7C); 	
...
unsigned char  WritenDataVKL060(unsigned char Addr,unsigned char *Databuf,unsigned char Cnt)
{
	...
	VKL060_I2CWRCmd(0xE8); 
	if( 1 == VKL060_I2CSlaveAck() )
	{
		VKL060_I2CStop();													
		return 0; 
	}
	VKL060_I2CWRCmd(Addr&0x1f); 						
	if( 1 == VKL060_I2CSlaveAck() )
	{
		VKL060_I2CStop();													
		return 0;
...
unsigned char  ReadnDataVKL060(unsigned char Addr,unsigned char *Databuf,unsigned char Cnt)
{
	unsigned char n;
...
void VKL060_DisAll(unsigned char dat)
{
	...
	{
		VKL060_dispram[segi]=dat;
	}
	WritenDataVKL060(0,VKL060_dispram,16);	
}
...
void VKL060_DisDotOn(unsigned char seg,unsigned char com)
{
	...
	if((seg%2)==0)
		...
		addrbit=(1<<(4+com));
	tempdat=VKL060_dispram[seg/2]|addrbit;
	VKL060_dispram[seg/2]=tempdat;
	WritenDataVKL060(addrbyte,&tempdat,1);		
}
...
{			
  ...
  Delay_nuS(100);
	...
	VKL060_I2CWRCmd(0xB8|0x00|0x04);  
...
{	
	...
	{		
		...
		VKL060_DisAll(0x55);			
		ReadnDataVKL060(0,VKL060_readbuf,16);	
		Delay_nmS(1500);					
		VKL060_DisAll(0xAA);			
		ReadnDataVKL060(0,VKL060_readbuf,16);	
		Delay_nmS(1500);					
		...
		VKL060_Exit_PowerOff();	
				...
				VKL060_DisAll(0x00);			
		Delay_nmS(500);						
		for(VKL060_segi=11;VKL060_segi<26;VKL060_segi++)
		{
			for(VKL060_comi=0;VKL060_comi<4;VKL060_comi++)
			{
				VKL060_DisDotOn(VKL060_segi,VKL060_comi);		
				Delay_nmS(300);				
				VKL060_DisDotOff(VKL060_segi,VKL060_comi);		
			}
		}
