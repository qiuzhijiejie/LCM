...
#line 1 "..\\lcd_driver\\VK2C21A_IO_I2C.h"
...
#line 20 "..\\lcd_driver\\VK2C21A_IO_I2C.h"
...
#line 52 "..\\lcd_driver\\VK2C21A_IO_I2C.h"
	
#line 69 "..\\lcd_driver\\VK2C21A_IO_I2C.h"
	
#line 87 "..\\lcd_driver\\VK2C21A_IO_I2C.h"
...
#line 15 "..\\lcd_driver\\VK2C21A_IO_I2C.c"
...
void WriteCmdVKL060(unsigned char Addr,unsigned char Cmd);
...
void  WriteCmdVK2C21A(unsigned char Addr,unsigned char Cmd)
{
	VK2C21A_I2C_WRCmd(Addr,Cmd);
}
...
{
  VK2C21A_I2C_WRDat(Addr,Databuf,Cnt);
	return 0;
}
...
{
  VK2C21A_I2C_RDDat(Addr,Databuf,Cnt);
	return 0;
}
