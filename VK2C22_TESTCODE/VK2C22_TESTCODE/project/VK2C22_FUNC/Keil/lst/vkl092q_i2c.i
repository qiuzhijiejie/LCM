...
#line 1 "..\\lcd_driver\\VKL092Q_I2C.h"
...
#line 20 "..\\lcd_driver\\VKL092Q_I2C.h"
...
#line 15 "..\\lcd_driver\\VKL092Q_I2C.c"
...
unsigned char VKL092Q_dispram[12];
unsigned char VKL092Q_readbuf[12];
...
void VKL092Q_I2C_Cmd(unsigned char* cmdbuf,unsigned char cnt);
void VKL092Q_I2C_WRDat(unsigned char Addr,unsigned char *Databuf,unsigned char cnt);
void VKL092Q_I2C_RDDat(unsigned char Addr,unsigned char *Databuf,unsigned char cnt);
...
void  WriteCmdVKL092Q(unsigned char cmd)
{
	VKL092Q_I2C_Cmd(&cmd,1);
}
...
void  WritenDataVKL092Q(unsigned char Addr,unsigned char *Databuf,unsigned char cnt)
{
	VKL092Q_I2C_WRDat(Addr,Databuf,cnt);
}
...
{
	VKL092Q_I2C_RDDat(Addr,Databuf,Cnt);
	return 0;
}
...
{	
	...
	{		
		...
		VKL092Q_DisAll(0xff);			
		Delay_nmS(500);						
		for(VKL092Q_segi=0;VKL092Q_segi<32;VKL092Q_segi++)
		{
			for(VKL092Q_comi=0;VKL092Q_comi<4;VKL092Q_comi++)
			{
				VKL092Q_DisDotOff(VKL092Q_segtab[VKL092Q_segi],VKL092Q_comi);		
