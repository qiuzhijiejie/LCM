...
void SYS_Init(void)
{
  ...
  CLK_EnableModuleClock(((((2UL) & 0x03) << 30)|((((17)) & 0x1f) << 0)| (((2) & 0x03) << 28)|(((1) & 0x07) << 25)|(((1) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)));
	...
	((SYS_T *) ((0x40000000UL) + 0x00000))->GPC_MFPH = (((SYS_T *) ((0x40000000UL) + 0x00000))->GPC_MFPH & (~(0xful << (28))));
	((SYS_T *) ((0x40000000UL) + 0x00000))->GPC_MFPH |= (6ul << (28));		
	
	 
	((SYS_T *) ((0x40000000UL) + 0x00000))->GPD_MFPL &= ~((0xful << (16)) | (0xful << (20)));
	((SYS_T *) ((0x40000000UL) + 0x00000))->GPD_MFPL |= ((3ul << (16)) | (3ul << (20)));

	 
	((GPIO_T *) ((0x40000000UL) + 0x040C0))->SMTEN |= ((0x1ul << (2)) | (0x1ul << (3)));
}
