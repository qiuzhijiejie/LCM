...
unsigned int SystemCoreClock  = (1*(12000000UL));     
unsigned int CyclesPerUs      = ((12000000UL) / 1000000);  
unsigned int PllClock         = (12000000UL);              
unsigned int gau32ClkSrcTbl[] = {(12000000UL), (32768UL), 0, (10000UL), 0, 0, 0, (22118400UL)};
