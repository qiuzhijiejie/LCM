...
unsigned int CLK_SetCoreClock(unsigned int u32Hclk)
{
    ...
    if(((CLK_T *) ((0x40000000UL) + 0x00200))->STATUS & (0x1ul << (0)))
...
void CLK_SetModuleClock(unsigned int u32ModuleIdx, unsigned int u32ClkSrc, unsigned int u32ClkDiv)
{
    ...
    if((((u32ModuleIdx) >>10) & 0xff) != 0x0)
    {
        ...
        u32div = (unsigned int)&((CLK_T *) ((0x40000000UL) + 0x00200))->CLKDIV0 + (((((u32ModuleIdx) >>18) & 0x3)) * 4);
    ...
    if((((u32ModuleIdx) >>25) & 0x7) != 0x0)
    {
        ...
        u32sel = (unsigned int)&((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL0 + (((((u32ModuleIdx) >>28) & 0x3)) * 4);
...
void CLK_EnableModuleClock(unsigned int u32ModuleIdx)
{
    *(volatile unsigned int *)((unsigned int)&((CLK_T *) ((0x40000000UL) + 0x00200))->AHBCLK + ((((u32ModuleIdx) >>30) & 0x3) * 4))  |= 1 << (((u32ModuleIdx) >>0 ) & 0x1f);
}
