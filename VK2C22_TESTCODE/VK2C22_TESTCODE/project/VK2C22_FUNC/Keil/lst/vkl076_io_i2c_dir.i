#line 1 "..\\lcd_driver\\VKL076_IO_I2C_DIR.c"
...
#line 1 "..\\lcd_driver\\VKL076_IO_I2C_DIR.h"
...
#line 20 "..\\lcd_driver\\VKL076_IO_I2C_DIR.h"
...
#line 15 "..\\lcd_driver\\VKL076_IO_I2C_DIR.c"
...
unsigned char VKL076_I2CSlaveAck( void )
{
...
void VKL076_I2CWRCmd( unsigned char cmd )
{
	unsigned char i=8;
...
void VKL076_I2CWRDat( unsigned char dat )
{
	unsigned char i=8;
	while (i--)
	{ 
...
unsigned char VKL076_I2CRDDat( void )
{
...
unsigned char  WriteCmdVKL076(unsigned char cmd)
{
	
	VKL076_I2CStart(); 									
	
	VKL076_I2CWRCmd(0x7C); 	
	if( 1 == VKL076_I2CSlaveAck() )
	{
		VKL076_I2CStop();													
		return 0;										
	}
...
unsigned char  WritenDataVKL076(unsigned char Addr,unsigned char *Databuf,unsigned char Cnt)
{
	unsigned char n;
	...
	VKL076_I2CWRCmd(0xE8); 
	if( 1 == VKL076_I2CSlaveAck() )
	{
		VKL076_I2CStop();													
		return 0; 
	}
	VKL076_I2CWRCmd(Addr&0x1f); 						
	if( 1 == VKL076_I2CSlaveAck() )
	{
		VKL076_I2CStop();													
		return 0;
	...
	for(n=0;n<Cnt;n++)
	{ 
		VKL076_I2CWRDat(*Databuf++);
		if( VKL076_I2CSlaveAck()==1 )
		{
			VKL076_I2CStop();													
			return 0;
		}
...
{			
  ...
  Delay_nuS(100);
	...
	VKL076_I2CWRCmd(0xB8|0x00|0x04);  
