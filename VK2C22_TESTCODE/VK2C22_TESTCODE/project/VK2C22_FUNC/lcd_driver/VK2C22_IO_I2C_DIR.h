...
//SDA脚设为输入脚，用于读ACK和读RAM数据
#define VK2C22_SET_SDA_IN() 	{\
	GPIO_SetMode(VK2C22_SDA_PORT, VK2C22_SDA_PIN, GPIO_MODE_INPUT);\
}
//SDA脚设为输出脚，用于发送命令和写显示RAM数据
#define VK2C22_SET_SDA_OUT() 	{\
	GPIO_SetMode(VK2C22_SDA_PORT, VK2C22_SDA_PIN, GPIO_MODE_OUTPUT);\
}
/* Exported functions ------------------------------------------------------- */
