/********************YEHUI**************************
*****************2.23‘   7PIN SPI OLED FOR AT89S52/STC12*************
*****AT89S52驱动**************************
***** P20----3  SCK   ,  P21----4  SDA   ,  
***** BY:GU 
*********SSD1305
...
const unsigned char code OLED_init_cmd[29]=
{
        0xAE,//关闭显示
	
       0xD5,//设置时钟分频因子,震荡频率
       0x10,  //[3:0],分频因子;[7:4],震荡频率
...
/********************************************************************************************************/
       ...
       0x81,//对比度设置
       0xBF,//1~255;默认0X7F (亮度设置,越大越亮)
	   
       0xD9,//设置预充电周期
       0xD2,//[3:0],PHASE 1;[7:4],PHASE 2;
	   
       0xDB,//设置VCOMH 电压倍率
       0X08,//[6:4] 000,0.65*vcc;001,0.77*vcc;011,0.83*vcc;
...
const unsigned char code picture_tab[]={
/*------------------------------------------------------------------------------
;  列行式，低位在前，阴码
;  宽×高（像素）: 128×64
------------------------------------------------------------------------------*/
