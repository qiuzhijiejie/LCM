...
0x00,0x00,0x00,0x04,0x0c,0x0c,0x14,0x24,   //字符008:[4]
...
//6.字符串测试: 在(16,72)位置显示"DFSTN:240*128 DOTS Display"字符串.
    XPOS=16;
    YPOS=72;
    putstr("DFSTN:240*128 DOTS Display");
    exdelay();                          //延时约600mS

//7.反显测试: 在(16,72)位置反显"DFSTN:240*128 DOTS Display"字符串.
    XPOS=16;
    YPOS=72;
    CharImageReverse=1;
    putstr("DFSTN:240*128 DOTS Display");
...
//8.绘图测试: RECT(15,47)-(239,127),画矩形.
    rect(0,0,239,127,1);
    exdelay();                          //延时约600mS

//9.绘图测试: point(15,92),画点.
    XPOS=15;
    YPOS=92;
    point(1);
    exdelay();                          //延时约600mS

//10.绘图测试: line(15,92)-(119,125),画线.
    line(15,92,119,125,1);
    exdelay();                          //延时约600mS

//11.绘图测试: lineto(224,92),画线.
    lineto(224,92,1);
    exdelay();                          //延时约600mS

//12.绘图测试: lineto(15,92),画线.
    lineto(15,92,1);
    exdelay();                          //延时约600mS
