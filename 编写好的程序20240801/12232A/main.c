 //----------------------------------------------------------------------
/*GUANGDONG YEHUI TECHNOLOGY CO,.LTD.*/
// Module    :YHBG12232A Series
// Lanuage   : C51 Code
// Create    : TOBU
// Date      : Apr-24-2020
// Drive IC  : SBN1661G_M18 
// INTERFACE : 6800_8bit 
// MCU 		 : STC89LE52RC  12M Crystal oscillator
// VDD		 : 3V      
//----------------------------------------------------------------------
...
#define A0                    P2_0  	//Selection of command or data.  1 :data  0 : command
#define E1                    P2_1		//Enable signal (E1) 
#define E2                    P2_2		//Enable signal (E2)
#define R_W                   P2_5		   //Read/Write (R/W) signal for the 68-type microcontroller, or WRITE(WR) signal for the 80-type microcontroller.
#define RST                   P2_6		//RESET PIN;

#define DATA_BUS              P1		//Data bus


sbit	int0=P3^2;						//external interrup input
bit log=0;								//display stop mark



void Display_One_Chinese(unsigned char page, unsigned char col, unsigned char Character_coding, unsigned char ft[]); 
...
void show_chinese(void)
{	Display_One_Chinese(0,0,0,ft); 
	Display_One_Chinese(0,16,1,ft); 
	Display_One_Chinese(0,32,2,ft); 	
	Display_One_Chinese(0,48,3,ft);
 	Display_One_Chinese(0,64,4,ft);
 	Display_One_Chinese(0,80,5,ft);
 	Display_One_Chinese(0,96,6,ft);
 	Display_One_Chinese(0,112,7,ft);

	Display_One_Chinese(2,0+6,8,ft); 
	Display_One_Chinese(2,16+6,9,ft); 
	Display_One_Chinese(2,32+6,10,ft);	
	Display_One_Chinese(2,48+6,11,ft);
 	Display_One_Chinese(2,64+6,12,ft);
 	Display_One_Chinese(2,80+6,13,ft);
 	Display_One_Chinese(2,96+6,14,ft);
 	Display_One_Chinese(2,112+6,15,ft);
...
void main(void)
{
	...
	while(1)
	{
		...
		Delay(2000);
		Display_dot(0x00,0x00); //clear display
