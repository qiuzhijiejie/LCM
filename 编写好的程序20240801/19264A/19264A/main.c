...
unsigned char code font[]=
{
/* [字库]：[HZK1616宋体] [数据排列]:从左到右从上到下 [取模方式]:纵向8点下高位 [正负反色]:否 [去掉重复后]共29个字符
[总字符库]："智力光电股份有限公司Ｉｎｔｅｌｉｇ　ＯｐｏｃｒｓＣ．，Ｌｄ"*/
...
/* [字库]：[ASC8x16E字库] [数据排列]:从左到右从上到下 [取模方式]:纵向8点下高位 [正负反色]:否 [去掉重复后]共37个字符
[总字符库]："Intelligent Optoelectronics Co., Ltd."*/
...
/*-- ID:1,字符:"n",ASCII编码:6E,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x40,0xc0,0x80,0x40,0x40,0x40,0x80,0x00,0x10,0x1f,0x10,0x00,0x00,0x10,0x1f,0x10,

/*-- ID:2,字符:"t",ASCII编码:74,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x40,0x40,0xf0,0x40,0x40,0x00,0x00,0x00,0x00,0x00,0x0f,0x10,0x10,0x08,0x00,

/*-- ID:3,字符:"e",ASCII编码:65,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x80,0x40,0x40,0x40,0x40,0x80,0x00,0x00,0x0f,0x12,0x12,0x12,0x12,0x0b,0x00,

/*-- ID:4,字符:"l",ASCII编码:6C,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x08,0x08,0xfc,0x00,0x00,0x00,0x00,0x00,0x10,0x10,0x1f,0x10,0x10,0x00,0x00,

/*-- ID:5,字符:"l",ASCII编码:6C,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x08,0x08,0xfc,0x00,0x00,0x00,0x00,0x00,0x10,0x10,0x1f,0x10,0x10,0x00,0x00,

/*-- ID:6,字符:"i",ASCII编码:69,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x40,0x4c,0xcc,0x00,0x00,0x00,0x00,0x00,0x10,0x10,0x1f,0x10,0x10,0x00,0x00,

/*-- ID:7,字符:"g",ASCII编码:67,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x80,0x40,0x40,0x40,0xc0,0x40,0x00,0x00,0x35,0x4a,0x4a,0x4a,0x49,0x30,0x00,

/*-- ID:8,字符:"e",ASCII编码:65,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x80,0x40,0x40,0x40,0x40,0x80,0x00,0x00,0x0f,0x12,0x12,0x12,0x12,0x0b,0x00,

/*-- ID:9,字符:"n",ASCII编码:6E,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x40,0xc0,0x80,0x40,0x40,0x40,0x80,0x00,0x10,0x1f,0x10,0x00,0x00,0x10,0x1f,0x10,

/*-- ID:10,字符:"t",ASCII编码:74,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x40,0x40,0xf0,0x40,0x40,0x00,0x00,0x00,0x00,0x00,0x0f,0x10,0x10,0x08,0x00,

/*-- ID:11,字符:" ",ASCII编码:20,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,

/*-- ID:12,字符:"O",ASCII编码:4F,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0xf0,0x08,0x04,0x04,0x04,0x08,0xf0,0x00,0x07,0x08,0x10,0x10,0x10,0x08,0x07,0x00,

/*-- ID:13,字符:"p",ASCII编码:70,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x40,0xc0,0x80,0x40,0x40,0x80,0x00,0x00,0x40,0x7f,0x48,0x10,0x10,0x08,0x07,0x00,

/*-- ID:14,字符:"t",ASCII编码:74,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x40,0x40,0xf0,0x40,0x40,0x00,0x00,0x00,0x00,0x00,0x0f,0x10,0x10,0x08,0x00,

/*-- ID:15,字符:"o",ASCII编码:6F,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x80,0x40,0x40,0x40,0x40,0x80,0x00,0x00,0x0f,0x10,0x10,0x10,0x10,0x0f,0x00,

/*-- ID:16,字符:"e",ASCII编码:65,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x80,0x40,0x40,0x40,0x40,0x80,0x00,0x00,0x0f,0x12,0x12,0x12,0x12,0x0b,0x00,

/*-- ID:17,字符:"l",ASCII编码:6C,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x08,0x08,0xfc,0x00,0x00,0x00,0x00,0x00,0x10,0x10,0x1f,0x10,0x10,0x00,0x00,

/*-- ID:18,字符:"e",ASCII编码:65,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x80,0x40,0x40,0x40,0x40,0x80,0x00,0x00,0x0f,0x12,0x12,0x12,0x12,0x0b,0x00,

/*-- ID:19,字符:"c",ASCII编码:63,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x00,0x80,0x40,0x40,0x40,0x80,0x00,0x00,0x07,0x08,0x10,0x10,0x10,0x08,0x00,

/*-- ID:20,字符:"t",ASCII编码:74,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x40,0x40,0xf0,0x40,0x40,0x00,0x00,0x00,0x00,0x00,0x0f,0x10,0x10,0x08,0x00,

/*-- ID:21,字符:"r",ASCII编码:72,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x40,0x40,0xc0,0x80,0x40,0x40,0xc0,0x00,0x10,0x10,0x1f,0x10,0x10,0x00,0x00,0x00,

/*-- ID:22,字符:"o",ASCII编码:6F,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x80,0x40,0x40,0x40,0x40,0x80,0x00,0x00,0x0f,0x10,0x10,0x10,0x10,0x0f,0x00,

/*-- ID:23,字符:"n",ASCII编码:6E,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x40,0xc0,0x80,0x40,0x40,0x40,0x80,0x00,0x10,0x1f,0x10,0x00,0x00,0x10,0x1f,0x10,

/*-- ID:24,字符:"i",ASCII编码:69,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x40,0x4c,0xcc,0x00,0x00,0x00,0x00,0x00,0x10,0x10,0x1f,0x10,0x10,0x00,0x00,

/*-- ID:25,字符:"c",ASCII编码:63,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x00,0x80,0x40,0x40,0x40,0x80,0x00,0x00,0x07,0x08,0x10,0x10,0x10,0x08,0x00,

/*-- ID:26,字符:"s",ASCII编码:73,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x80,0x40,0x40,0x40,0x40,0xc0,0x00,0x00,0x19,0x12,0x12,0x12,0x12,0x0c,0x00,

/*-- ID:27,字符:" ",ASCII编码:20,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,

/*-- ID:28,字符:"C",ASCII编码:43,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0xe0,0x18,0x04,0x04,0x04,0x04,0x1c,0x00,0x03,0x0c,0x10,0x10,0x10,0x08,0x04,0x00,

/*-- ID:29,字符:"o",ASCII编码:6F,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x80,0x40,0x40,0x40,0x40,0x80,0x00,0x00,0x0f,0x10,0x10,0x10,0x10,0x0f,0x00,

/*-- ID:30,字符:".",ASCII编码:2E,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x00,0x00,0x00,0x00,0x00,

/*-- ID:31,字符:",",ASCII编码:2C,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x48,0x38,0x00,0x00,0x00,0x00,0x00,

/*-- ID:32,字符:" ",ASCII编码:20,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,

/*-- ID:33,字符:"L",ASCII编码:4C,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x04,0xfc,0x04,0x00,0x00,0x00,0x00,0x00,0x10,0x1f,0x10,0x10,0x10,0x10,0x18,0x00,

/*-- ID:34,字符:"t",ASCII编码:74,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x40,0x40,0xf0,0x40,0x40,0x00,0x00,0x00,0x00,0x00,0x0f,0x10,0x10,0x08,0x00,

/*-- ID:35,字符:"d",ASCII编码:64,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x80,0x40,0x40,0x40,0x48,0xf8,0x00,0x00,0x0f,0x10,0x10,0x10,0x08,0x1f,0x10,

/*-- ID:36,字符:".",ASCII编码:2E,对应字:宽x高=8x16,画布:宽W=8 高H=16,共16字节*/
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x00,0x00,0x00,0x00,0x00
