//SMG24064B标准图形点阵型液晶显示模块的演示程序[C51编程语言][MCS51模拟口线方式]
//应用产品: SMG24064B标准图形点阵型液晶显示模块
//  本演示程序适用于SMG24064B液晶显示模块与MCS51系列单片机采用MCS51模拟口线的
//硬件连线方式,本程序跟SMG240128A的程序几乎完全兼容,只是显示的行数只有240128A的一半.
//  本演示程序包括T6963C兼容芯片的MCS51模拟口线方式子程序集,T6963C兼容芯片的24064
//液晶显示模块的基本子程序,24064系列绘图子程序集,24064系列图形子程序集,24064系
//列精简中英文字库子程序集,以及SMG24064系列标准图形点阵型液晶显示的扩展演示子程序.
//  本演示的内容为,在240列X64行的点阵液晶显示屏上清屏,图片演示,英文字符串演示,中文
...
//参考网页: http:/www.sunman.cn/lcm/product/SMG24064B.html
//-------------------------------------------------------------------------------
#include <reg51.h>
#include <intrins.h>
//以下为演示程序的函数定义
...
//PIN22:BLK  [背光源负极]---------------VSS
//注:8031的晶振频率为12MHz.
//请参见http://download.sunman.cn/lcm/product/1/SMG24064B.pdf
//-------------------------------------------------------------------------------
//以下为产品接口引脚在演示程序中的预定义
...
#define ENGLISHCHARNUMBER  34      //精简版英文字符库中的英文字符的个数
...
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,   //字符002:[-]
0x7e,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,   //字符003:[.]
0x00,0x00,0x00,0x00,0x60,0x60,0x00,0x00,
0x00,0x00,0x00,0x18,0x24,0x42,0x42,0x42,   //字符004:[0]
0x42,0x42,0x42,0x42,0x24,0x18,0x00,0x00,
0x00,0x00,0x00,0x3c,0x42,0x42,0x42,0x02,   //字符005:[2]
0x04,0x08,0x10,0x20,0x42,0x7e,0x00,0x00,
0x00,0x00,0x00,0x04,0x0c,0x0c,0x14,0x24,   //字符006:[4]
0x24,0x44,0x7f,0x04,0x04,0x1f,0x00,0x00,
0x00,0x00,0x00,0x18,0x24,0x40,0x40,0x5c,   //字符007:[6]
0x62,0x42,0x42,0x42,0x22,0x1c,0x00,0x00,
0x00,0x00,0x00,0x10,0x10,0x18,0x28,0x28,   //字符008:[A]
0x24,0x3c,0x44,0x42,0x42,0xe7,0x00,0x00,
0x00,0x00,0x00,0xf8,0x44,0x44,0x44,0x78,   //字符009:[B]
0x44,0x42,0x42,0x42,0x44,0xf8,0x00,0x00,
0x00,0x00,0x00,0x3e,0x42,0x42,0x80,0x80,   //字符010:[C]
0x80,0x80,0x80,0x42,0x44,0x38,0x00,0x00,
0x00,0x00,0x00,0xf8,0x44,0x42,0x42,0x42,   //字符011:[D]
0x42,0x42,0x42,0x42,0x44,0xf8,0x00,0x00,
0x00,0x00,0x00,0xfc,0x42,0x48,0x48,0x78,   //字符012:[E]
0x48,0x48,0x40,0x42,0x42,0xfc,0x00,0x00,
0x00,0x00,0x00,0x7c,0x10,0x10,0x10,0x10,   //字符013:[I]
0x10,0x10,0x10,0x10,0x10,0x7c,0x00,0x00,
0x00,0x00,0x00,0xe0,0x40,0x40,0x40,0x40,   //字符014:[L]
0x40,0x40,0x40,0x40,0x42,0xfe,0x00,0x00,
0x00,0x00,0x00,0xee,0x6c,0x6c,0x6c,0x6c,   //字符015:[M]
0x6c,0x54,0x54,0x54,0x54,0xd6,0x00,0x00,
0x00,0x00,0x00,0xc7,0x62,0x62,0x52,0x52,   //字符016:[N]
0x4a,0x4a,0x4a,0x46,0x46,0xe2,0x00,0x00,
0x00,0x00,0x00,0x38,0x44,0x82,0x82,0x82,   //字符017:[O]
0x82,0x82,0x82,0x82,0x44,0x38,0x00,0x00,
0x00,0x00,0x00,0xfc,0x42,0x42,0x42,0x7c,   //字符018:[R]
0x48,0x48,0x44,0x44,0x42,0xe3,0x00,0x00,
0x00,0x00,0x00,0x3e,0x42,0x42,0x40,0x20,   //字符019:[S]
0x18,0x04,0x02,0x42,0x42,0x7c,0x00,0x00,
0x00,0x00,0x00,0xfe,0x92,0x10,0x10,0x10,   //字符020:[T]
0x10,0x10,0x10,0x10,0x10,0x38,0x00,0x00,
0x00,0x00,0x00,0xd6,0x54,0x54,0x54,0x54,   //字符021:[W]
0x54,0x6c,0x28,0x28,0x28,0x28,0x00,0x00,
0x00,0x00,0x00,0x7e,0x84,0x04,0x08,0x08,   //字符022:[Z]
0x10,0x20,0x20,0x42,0x42,0xfc,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x38,   //字符023:[a]
0x44,0x0c,0x34,0x44,0x4c,0x36,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1c,   //字符024:[c]
0x22,0x40,0x40,0x40,0x22,0x1c,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x3c,   //字符025:[e]
0x42,0x42,0x7e,0x40,0x42,0x3c,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x3e,   //字符026:[g]
0x44,0x44,0x38,0x40,0x3c,0x42,0x42,0x3c,
0x00,0x00,0x00,0x00,0xc0,0x40,0x40,0x5c,   //字符027:[h]
0x62,0x42,0x42,0x42,0x42,0xe7,0x00,0x00,
0x00,0x00,0x00,0x30,0x30,0x00,0x00,0x70,   //字符028:[i]
0x10,0x10,0x10,0x10,0x10,0x7c,0x00,0x00,
0x00,0x00,0x00,0x10,0x70,0x10,0x10,0x10,   //字符029:[l]
0x10,0x10,0x10,0x10,0x10,0x7c,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xdc,   //字符030:[n]
0x62,0x42,0x42,0x42,0x42,0xe7,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x3c,   //字符031:[o]
0x42,0x42,0x42,0x42,0x42,0x3c,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xee,   //字符032:[r]
0x32,0x20,0x20,0x20,0x20,0xf8,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x10,0x10,0x7c,   //字符033:[t]
0x10,0x10,0x10,0x10,0x12,0x0c,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xe7,   //字符034:[y]
...
//1.图片测试: 在(1,19)位置显示32点阵SUNMAN图标
    XPOS=1;
    YPOS=19;
    putimage(Img_sunman_32);            //写数据到当前LCDRAM地址中
    exdelay();                          //延时约600mS

//2.字符串测试: 在(6,3)位置显示"LCM24064B Oriental Technology"字符串.
    XPOS=6;
    YPOS=3;
    putstr("LCM24064B Oriental Technology");
    exdelay();                          //延时约600mS

//3.字符串测试: 在(40,32)位置显示"WWW.ORIENTAL-LCD.COM"字符串.
    XPOS=40;
    YPOS=32;
    putstr("WWW.ORIENTAL-LCD.COM");
    exdelay();                          //延时约600mS

//4.反显测试: 在(40,32)位置反显"WWW.ORIENTAL-LCD.COM"字符串.
    XPOS=40;
    YPOS=32;
    CharImageReverse=1;
    putstr("WWW.ORIENTAL-LCD.COM");
...
//5.绘图测试: RECT(0,0)-(239,63),画矩形.
    rect(0,0,239,63,1);
    exdelay();                          //延时约600mS

//6.绘图测试: point(14,52),画点.
    XPOS=14;
    YPOS=52;
    point(1);
    exdelay();                          //延时约600mS

//7.绘图测试: line(14,85)-(119,63),画线.
    line(14,52,119,63,1);
    exdelay();                          //延时约600mS

//8.绘图测试: lineto(225,52),画线.
    lineto(225,52,1);
    exdelay();                          //延时约600mS

//9.绘图测试: lineto(14,52),画线.
    lineto(14,52,1);
    exdelay();                          //延时约600mS
...
//-------------------------------------------------------------------------------
//以下lcdfill,lcdpos,lcdreset为T6963型硬件接口的24064液晶显示模块的基本子程序
//-------------------------------------------------------------------------------
