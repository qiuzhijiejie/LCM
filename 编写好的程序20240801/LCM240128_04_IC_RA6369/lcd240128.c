...
#define Graphic		1
#define	Character 	0
#define CMD_FONT_SELECT 0x70  // 字库选择命令
#define LCM_PORT P1
...
void Display_FullCGROM()
{
	...
	Display_Str(0,8,"ABCDEFGopkrst435"); 
	Display_FullCGROM_SpecifiedPositions();
	Display_FullCGROM_SpecifiedPositions2();
}
...
void DisplayPatterns() 
{
    ...
    switch (step) 
    {
        case 0:  DisplayDots(0x55, 0xAA); Delay(5000); break;
        case 1:  DisplayDots(0xAA, 0x55); Delay(5000); break;
        case 2:  DisplayDots(0x55, 0x55); Delay(5000); break;
        case 3:  DisplayDots(0xAA, 0xAA); Delay(5000); break;
        case 4:  DisplayDots(0xFF, 0x00); Delay(5000); break;
        case 5:  DisplayDots(0x00, 0xFF); Delay(5000); break;
        case 6:  DisplayDots(0xFF, 0xFF); Delay(5000); break;
        case 7:  LcmClear(); DisplayBMP(0, 0, 240, 128, BMP1); Delay(5000); break;
        case 8:  ReverseDisplayBMP(0, 0, 240, 128, BMP1); Delay(5000); break;
        case 9:  LcmClear(); Display_FullCGROM(); Delay(5000); break;
        case 10: LcmClear(); picture(); Delay(5000); break;
    }
