...
void DisplayPatterns() 
{
    ...
    switch (step) 
    {
        case 0: LcmPutDots(0x55, 0xaa); Delay(500); break;
        case 1: LcmPutDots(0xaa, 0x55); Delay(500); break;
        case 2: LcmPutDots(0x55, 0x55); Delay(500); break;
        case 3: LcmPutDots(0xaa, 0xaa); Delay(500); break;
        case 4: LcmPutDots(0xff, 0x00); Delay(500); break;
        case 5: LcmPutDots(0x00, 0xff); Delay(500); break;
        case 6: LcmPutDots(0xff, 0xff); Delay(500); break;
        case 7: Display_Chinese();Delay(500); break;
    }
    step++;
    if (step > 7) step = 0;
}
