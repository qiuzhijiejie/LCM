...
//Resolution
uchar	 SIZE;
#define Max_Column	192
#define Max_Row		64



#define WriteCMD_Address 0x7C	 //CS:HIGH
#define WriteDATA_Address 0x7E	 //CS:HIGH
...
void main(void)
{
	...
	while(1)
	{
		...
		ShowCHinese(80,2,12); 
 		ShowCHinese(96,2,13); 
		ShowCHinese(112,2,14); 
 		ShowCHinese(128,2,15); 			 

		SIZE=16;
		ShowString(10,4,"www,buydisplay.com");
		SIZE=8;
	 	ShowString(0,6,"EastRising Technology.LT");  
 	 	ShowString(40,7,"Hollw!World!"); 
		delay_ms(2000);
		...
		DrawBMP(0,0,192,8,pic1); //x:0,y:0,col:192,line:8*8=64 	 
		delay_ms(2000);
...
//	    Write_Instruction(0xa6);  //Set normal display 
		...
		DrawBMP(0,0,192,8,pic2);  //x:0,y:0,col:192,line:8*8=64 
		delay_ms(2000);
// 	    Write_Instruction(0xa7);  //Set  inverse  display 	 
//		delay_ms(1000);
//	    Write_Instruction(0xa6);  //Set normal display 
		...
		DrawBMP(0,0,192,8,pic3);  //x:0,y:0,col:192,line:8*8=64 
		delay_ms(2000);
 //	    Write_Instruction(0xa7);  //Set  inverse  display 	 
//		delay_ms(1000);
//	    Write_Instruction(0xa6);  //Set normal display 
		...
		DrawBMP(0,0,192,8,pic4);  //x:0,y:0,col:192,line:8*8=64 
		delay_ms(2000);
 //	    Write_Instruction(0xa7);  //Set  inverse  display 	 
//		delay_ms(1000);
//	    Write_Instruction(0xa6);  //Set normal display 
...
void Initial(void)
{
	...
	delay_ms(10);
 	...
 	Write_Instruction(0xe2);//system reset
  	...
  	Write_Instruction(0xa0);//set Frame Rate[A0: 76fps, A1b: 95fps, A2b: 132fps, A3b: 168fps(fps: frame-per-second)] 
 
  	Write_Instruction(0xeb);//set BR 1/9 

  	Write_Instruction(0xc4);//set Scan Direction 
  	Write_Instruction(0x81);//set PM
  	Write_Instruction(Contrast); //set PM 110
...
void ShowString(unsigned char x,unsigned char y,unsigned char *chr)
{
	...
	{		ShowChar(x,y,chr[j]);
			x+=8;
		if(x>184){x=0; if(SIZE==16)y+=2;else y+=1;}
			j++;
	}
}
//ShowCHinese
...
0x01,0x01,0x01,0x01,0x81,0xF1,0xF9,0xFF,0xFD,0xC1,0x01,0x01,0x01,0x01,0x01,0x01,
0x01,0x01,0xC1,0xE1,0xF1,0xF9,0xF9,0xFD,0xFD,0xF9,0xF1,0xE1,0xE1,0xB1,0x11,0x19,
0x1D,0x1D,0x0D,0x09,0x19,0x19,0x19,0x09,0x09,0x39,0xF9,0xD9,0x81,0x01,0x01,0x01,
...
0x81,0x81,0xC1,0x81,0x01,0xF1,0xFD,0xF9,0xF1,0xC1,0x81,0x01,0x01,0x01,0x01,0x01,
...
,
...
,
...
,
...
0x07,0x1E,0x79,0xE3,0x86,0x0C,0xC8,0xF8,0xF1,0x73,0x23,0x23,0x23,0x63,0x61,0x60,
0x40,0x40,0x40,0x60,0xE0,0xE0,0xE0,0x60,0xE0,0xF0,0xF0,0xF8,0xCC,0x0C,0x06,0x03,
0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x80,0