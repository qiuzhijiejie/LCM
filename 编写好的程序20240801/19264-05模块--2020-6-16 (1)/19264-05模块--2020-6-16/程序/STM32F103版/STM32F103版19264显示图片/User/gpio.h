...
#define CD						GPIO_Pin_1																	//定义显示屏指令/数据选择引脚
#define RST						GPIO_Pin_2																	//定义显示屏复位引脚
#define SCK 					GPIO_Pin_3																	//定义数据总线时钟引脚
#define SDA 					GPIO_Pin_4																	//定义数据总线数据引脚

#define CS_1()  			GPIO_SetBits(Port,CS)												//片选至 1
#define CS_0()  			GPIO_ResetBits(Port,CS)											//片选至 0

#define CD_1()  			GPIO_SetBits(Port,CD)												//指令/数据至 1
#define CD_0()  			GPIO_ResetBits(Port,CD)											//指令/数据至 0

#define RST_1()  			GPIO_SetBits(Port,RST)											//复位至 1
#define RST_0()  			GPIO_ResetBits(Port,RST)										//复位至 0

#define SCK_1()  			GPIO_SetBits(Port,SCK)											//时钟至 1
#define SCK_0()  			GPIO_ResetBits(Port,SCK)										//时钟至 0
